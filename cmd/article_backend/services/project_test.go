...
func newMockProjectDAO() projectDAO {
	return &mockProjectDAO{
		records: []models.Project{
			{Model: models.Model{ID: 1}, Name: "IoT Cloud", ThumbnailPictureURL: "https://via.placeholder.com/150", URL: "https://github.com/Panda-ManR/IoT-Cloud", Description: "Cloud framework for IoT (Internet of Things), which focuses on security and privacy of its users, their devices and data"},
			{Model: models.Model{ID: 2}, Name: "article & Personal Website", ThumbnailPictureURL: "https://via.placeholder.com/150", URL: "https://github.com/Panda-ManR/article-backend", Description: "This website. Goal of this project was to learn Go and Vue.js and as a byproduct I created personal website and article."},
		},
	}
}
