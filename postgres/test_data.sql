INSERT INTO posts (title, text, author, posted_on, next_post_id, previous_post_id) VALUES ('First article Post', 'This is article about something.', 'Martin', '2018-08-24 14:00:00', null, null);
INSERT INTO posts (title, text, author, posted_on, next_post_id, previous_post_id) VALUES ('Second article Post', 'This is article about something else...', 'Martin', '2019-02-24 13:00:00', null, null);
INSERT INTO posts (title, text, author, posted_on, next_post_id, previous_post_id) VALUES ('3rd article Post', 'Another dummy content', 'Martin', '2019-05-30 19:00:00', null, null);
...
INSERT INTO projects (name, thumbnail_url, url, description) VALUES ('IoT Cloud', 'https://via.placeholder.com/150', 'https://github.com/Panda-ManR/IoT-Cloud', 'Cloud framework for IoT (Internet of Things), which focuses on security and privacy of its users, their devices and data');
INSERT INTO projects (name, thumbnail_url, url, description) VALUES ('article & Personal Website', 'https://via.placeholder.com/150', 'https://github.com/Panda-ManR/article-backend', 'This website. Goal of this project was to learn Go and Vue.js and as a byproduct I created personal website and article.');
